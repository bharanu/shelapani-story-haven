...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Shelapani Homes" },
      { name: "description", content: "Premium experience-led villa stay website for Shelapani Homes in Shimla." },
      { name: "author", content: "Shelapani Homes" },
      { property: "og:title", content: "Shelapani Homes" },
      { property: "og:description", content: "Premium experience-led villa stay website for Shelapani Homes in Shimla." },
